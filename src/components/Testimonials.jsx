...
const Testimonials = () => {
  return (
    <div className="container mx-auto py-10 lg:px-32 w-full overflow-hidden" id='Testimonials'>
        <h1 className='text-center first-letter:text-6xl text-3xl sm:text-4xl font-bold mb-2'>Customer <span className="underline underline-offset-4 decoration-1 font-light">Testimonials</span></h1>
        <p className=' text-center text-gray-500 mb-12 max-w-70 mx-auto'>Real Stories from Those who Found Home with Us</p>
